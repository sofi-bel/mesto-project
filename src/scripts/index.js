...
const closeAddPlacePopupButton = document.querySelector(
  ".popup__close-button_type_add-place",
);
const closeOpenImagePopupButton = document.querySelector(
  ".popup__close-button_type_image-place",
);
